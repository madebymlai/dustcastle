...
//   IN-SANDBOX by a real `go mod download`, NOT mounted offline from a deps FOD.
//
...
describe("dustcastle run (slice 1: Go in-Sandbox install, ADR 0002/0008/0012/0020)", () => {
  e2e(
    "fetches Go modules in-Sandbox over normal networking, then runs `go test` green",
    async () => {
