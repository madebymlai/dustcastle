...
describe("detect — Rust ecosystem (Cargo, dustcastle-gy5.2)", () => {
  ...
  it("records rust-toolchain.toml's [toolchain] channel as the Toolchain version", () => {
    const dir = repo({
      "Cargo.toml": '[package]\nname = "sample"\nversion = "0.1.0"\nrust-version = "1.70"\n',
      "Cargo.lock": "# generated by cargo\nversion = 4\n",
    ...
    expect(detect(dir)[0]).toMatchObject({ ecosystem: "rust", toolchainVersion: "1.76.0" });
  });
  ...
  it("falls back to the legacy rust-toolchain file", () => {
    ...
    expect(detect(dir)[0]).toMatchObject({ ecosystem: "rust", toolchainVersion: "nightly-2026-01-01" });
  });

  it("does not treat Cargo.toml rust-version (MSRV) as the Toolchain version", () => {
    const dir = repo({
      "Cargo.toml": '[package]\nname = "sample"\nversion = "0.1.0"\nrust-version = "1.70"\n',
      "Cargo.lock": "# generated by cargo\nversion = 4\n",
    });
  ...
  it("leaves the Rust Toolchain version undefined when no rustup version file is present", () => {
    const dir = repo({
      "Cargo.toml": '[package]\nname = "sample"\nversion = "0.1.0"\n',
      "Cargo.lock": "# generated by cargo\nversion = 4\n",
    });
